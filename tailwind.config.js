...
export default {
  ...
  safelist: [
    ...
    'bg-emerald-50', 'bg-emerald-50/80', 'bg-emerald-100', 'bg-emerald-500', 'dark:bg-emerald-900/10', 'dark:bg-emerald-900/20', 'dark:bg-emerald-900/30',
    'bg-brand-50', 'bg-brand-50/50', 'bg-brand-50/80', 'bg-brand-100', 'bg-brand-500', 'dark:bg-brand-900/10', 'dark:bg-brand-900/20', 'dark:bg-brand-900/30',
    'bg-violet-50', 'bg-violet-50/80', 'bg-violet-100', 'bg-violet-500', 'dark:bg-violet-900/20', 'dark:bg-violet-900/30',
    'bg-cyan-50', 'dark:bg-cyan-900/20',
    'bg-fuchsia-50', 'dark:bg-fuchsia-900/20',
    'bg-accent-50', 'dark:bg-accent-900/20',
    'bg-slate-50', 'dark:bg-slate-800/60', 'border-slate-200', 'border-slate-400', 'dark:border-slate-600', 'dark:border-slate-700',
    ...
    'text-violet-300', 'text-violet-500', 'text-violet-600', 'text-violet-700', 'text-violet-800', 'dark:text-violet-200', 'dark:text-violet-300', 'dark:text-violet-400',
